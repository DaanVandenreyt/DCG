...
#     print(os.getcwd())
#     with open('./django_cookiecutter_gumbys/my-django-cookiecutter/cookiecutter.json') as cookies_file:
...
#                 data[key] = user_input
#
#         # Set different casing options for the project name,
#         # starting with snake_case gives the best results with inflection
...
#
#     cookiecutter(f'{project_dir}/django_cookiecutter_gumbys/my-django-cookiecutter')
#     # cookiecutter(f'{project_dir}/django_cookiecutter_gumbys/my-django-cookiecutter',
